        ...
        <AnimatePresence mode="wait">
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    transition={{ type: 'spring', damping: 25, stiffness: 400, mass: 1 }}
                    className="relative bg-white rounded-[32px] shadow-2xl w-full max-w-[540px] overflow-hidden border border-white/20"
                >
                    {/* Header */}
                    <div className="relative h-32 bg-indigo-600 flex items-center justify-center overflow-hidden">
                        ...
                        <button
                            onClick={onClose}
                            className="absolute top-6 right-6 p-2 rounded-xl bg-black/10 text-white hover:bg-black/20 transition-all active:scale-90"
                        >
                            <X className="w-5 h-5" />
                        </button>
                    </div>
                            ...
                            <div className="space-y-6 text-center">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-gray-500 leading-relaxed px-4 text-center">
                                        {type === 'project'
                                            ...
                                            : "You can't create more than 4 versions per project during the private beta."}
                                    </p>
                                </div>
                                ...
                                <div className="pt-4 flex flex-col gap-3">
                                    <button
                                        ...
                                        className="w-full py-4 bg-gray-900 text-white rounded-2xl font-black text-sm hover:bg-black transition-all shadow-lg shadow-gray-900/20 active:scale-[0.98] flex items-center justify-center gap-2"
                                    >
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    {[
                                        ...
                                        { icon: CheckCircle2, text: "Up to 4 schema versions per project", color: "text-green-500" },
                                ...
                                <button
                                    onClick={onClose}
                                    className="w-full py-4 bg-gray-900 text-white rounded-2xl font-black text-sm hover:bg-black transition-all shadow-lg shadow-gray-900/20 active:scale-[0.98]"
                                >
