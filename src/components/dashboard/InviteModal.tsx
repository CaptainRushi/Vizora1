...
export function InviteModal({ workspaceId, workspaceName, onClose, onInviteGenerated }: InviteModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl w-[520px] overflow-hidden transform transition-all scale-100">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    >
                                        ...
                                        <p className="text-xs text-gray-500">Full workspace access & invites.</p>
                                        {role === 'admin' && (
