...
export function MainLayout({ children }: MainLayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 lg:grid lg:grid-cols-[72px_1fr] flex flex-col">
            ...
            <main className="flex-1 w-full relative overflow-y-auto">
                <div className="min-h-[calc(100vh-2rem)] w-full bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:20px_20px]">
                    {children}
                </div>
            </main>
